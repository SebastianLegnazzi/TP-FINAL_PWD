        ...
        <div class="mb-3">
            ...
            ?>
                ...
                foreach ($arrayProductos as $producto) {
                    ...
                    echo '<td><a class="edit" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
...
<div class="container-fluid col-md-10 text-white mt-5">
        ...
        <form  id='form-editar' method="post" action="../Accion/accionActualizarProductos.php"class="needs-validation row text-white justify-content-center col-12" novalidate>
                <table class="table table-striped table-dark">
                    ...
                    <td><div class="col-lg-7 col-12"><input type="number" style="width: 40px;" name="idProducto" required></input></div>
                    ...
                    <td><div class="col-lg-7 col-12"><input type="text" style="width: 150px;" name="proDetalle" required></input><div class="invalid-feedback">
                    Por favor ingrese algún detalle.</div>
                    <div class="valid-feedback">
                    Correcto!</div></div></td>
                    
                    <td><div class="col-lg-7 col-12"><input type="number" min="0" name="proCantStock" style="width: 100px;" required></input><div class="invalid-feedback">
                    ...
                    <td><div class="col-lg-7 col-12 "><input type="number" style="width: 100px;" min="0" name="proPrecio" required></input><div class="invalid-feedback">
